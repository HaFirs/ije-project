    ...
    " data-prev-text="Previous" data-next-text="Next">
        ...
        <small class="block">CEO, Project Manager</small>
                                ...
                                <ul class="list-inline text-center social-icons social-simple">
                                    <li>
                                        <a href="about-me roy.html" target="_self">
        ...
        <small class="block">Game Designer, Creative Director</small>
                                ...
                                <ul class="list-inline text-center social-icons social-simple">
                                    <li>
                                        <a href="about-me indra.html" target="_self">
        ...
        <small class="block">Web Developer, Technical Support</small>
                                ...
                                <ul class="list-inline text-center social-icons social-simple">
                                    <li>
                                        <a href="about-me vino.html" target="_self">
        ...
        <small class="block">Web Developer, Technical Support</small>
                                ...
                                <ul class="list-inline text-center social-icons social-simple">
                                    <li>
                                        <a href="about-me willi.html" target="_self">
                                            <i class="fa fa-facebook"></i>
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <blockquote class="fancy-blockquote">
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <p>Mas Roy memang pecinta wanita, kangen Vino shii, William bukan visual menurutku</p>
                                                    <small>Hani, EXID
