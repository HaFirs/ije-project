<?= $this->extend('ije/layout/template'); ?>
                ...
                <div class="row no-gutters slider-text js-fullheight align-items-center">
                    <div class="col-md-12 ftco-animate">
                        ...
                        <div class="text">
                            ...
                            <p>A small river named Duden flows by their place and supplies it with the necessary
                                regelialia.</p>
                            <p class="mb-0"><a href="#" class="btn btn-primary py-md-3 py-2 px-2 px-md-4">Explore
                                    Projects</a></p>
                        </div>
                    </div>
                    <a href="https://vimeo.com/45830194" class="img-video popup-vimeo d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="absolute">
                                        ...
                                        <div class="d-flex w-100">
                                            <div class="icon d-flex align-items-center ml-md-auto mb-4">
                                                <div class="img" style="background-image: url(assets/ije/logos/nios.png);"></div>
                            ...
                            <div class="px-4 px-lg-4">
                                <div class="desc text-md-right">
                                    ...
                                    <div class="absolute">
                                        ...
                                        <div class="d-flex w-100">
                                            <div class="icon d-flex align-items-center ml-md-auto mb-4">
                                                <div class="img" style="background-image: url(assets/ije/logos/photoworks.png);"></div>
                                                <div class="position pl-3 text-left">
                                                    <h4 class="mb-0">Jamie Jonson</h4>
                                                    <span>avo.com</span>
                                                </div>
