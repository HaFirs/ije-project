...
<head>
	...
	<link rel="icon" href="assets/ije/logos/1group.png">
	<meta charset="utf-8">
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html"><img alt="icon" src="assets/ije/logos/1group.png"></a>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="#companiesec" class="nav-link">Companies</a></li>
					<li class="nav-item"><a href="#aboutsec" class="nav-link">About</a></li>
					<li class="nav-item"><a href="#contactsec" class="nav-link">Contact Us</a></li>
				</ul>
			</div>
		</div>
	</nav>
